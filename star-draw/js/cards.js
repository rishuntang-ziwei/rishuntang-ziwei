...
export const DECK = {
  major: [
    ...
    { id: 'm09', name: '貪狼', theme: '資源', themeEn: 'Resources', rank: 'Q', suit: 'diamond', element: '木', fortune: '臣', keywords: '才華、能力、學習', keywordsEn: 'Talent, Ability, Learning', image: 'assets/cards/major/tan-lang.png' },
  ...
  tierB: [
    ...
    { id: 'b04', name: '右弼', theme: '協力', themeEn: 'Aid', rank: 8, suit: 'club', element: '水', fortune: '吉', keywords: '助力、得力助手', keywordsEn: 'Assistance, Right-hand man', image: 'assets/cards/tierB/you-bi.png' },
    { id: 'b05', name: '文昌', theme: '質感', themeEn: 'Classy', rank: 8, suit: 'heart', element: '水', fortune: '吉', keywords: '學習、專業、圓潤', keywordsEn: 'Learning, Professional, Mellow', image: 'assets/cards/tierB/wen-chang.png' },
    { id: 'b06', name: '文曲', theme: '程度', themeEn: 'Level', rank: 6, suit: 'heart', element: '水', fortune: '吉', keywords: '才華、技術、圓潤', keywordsEn: 'Talent, Technology, Mellow', image: 'assets/cards/tierB/wen-qu.png' },
  ...
  tierC: [
    ...
    { id: 'c05', name: '天姚', theme: '社交', themeEn: 'Social', rank: 7, suit: 'spade', element: '水', fortune: '桃', keywords: '異性、互動、交往', keywordsEn: 'Opposite sex, Interaction, Communication', image: 'assets/cards/tierC/tian-yao.png' },
    ...
    { id: 'c09', name: '喜神', theme: '對的', themeEn: 'Right', rank: 3, suit: 'heart', element: '火', fortune: '佑', keywords: '好事臨門、愉悅', keywordsEn: 'Good things come, Happy', image: 'assets/cards/tierC/xi-shen.png' },
